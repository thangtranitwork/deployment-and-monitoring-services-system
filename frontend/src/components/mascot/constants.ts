...
export const ITEM_CONFIG: ItemConfig[] = [
  ...
  { id: 'basic', name: 'Tụ Linh Đan', emoji: '💊', iconImage: '/pills/01_tu_linh_dan.png', xpValue: 8, maxStack: 999, rarity: 'common', category: 'xp', buyPrice: 15, sellPrice: 6, description: '+8 Linh Lực (XP) • Nhận: tỉ lệ may mắn khi treo máy, kéo thả Thỏ, Lò Luyện Đan' },
  { id: 'recover', name: 'Hồi Phục Đan', emoji: '🍃', iconImage: '/pills/04_hoi_khi_dan.png', xpValue: 20, maxStack: 999, rarity: 'uncommon', category: 'xp', buyPrice: 40, sellPrice: 16, description: '+20 Linh Lực (XP) • Nhận: deploy thành công, Lò Luyện Đan Bát Quái' },
  { id: 'great', name: 'Đại Hoàn Đan', emoji: '🌸', iconImage: '/pills/24_dai_hoi_khi_dan.png', xpValue: 50, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 90, sellPrice: 36, description: '+50 Linh Lực (XP) • Nhận: Độ Kiếp thành công, Lò Luyện Đan Bát Quái' },

  // ─── Nhóm Đan Dược Đột Phá Cảnh Giới (Đặc Thù Theo Cấp Bậc) ────────────────
  { id: 'pill_truc_co', name: 'Trúc Cơ Đan', emoji: '🌱', iconImage: '/pills/09_truc_co_dan.png', xpValue: 20, maxStack: 99, rarity: 'uncommon', category: 'breakthrough', targetRealmIndex: 1, breakthroughBonus: 0.30, isBuff: true, buffDurationMs: 5 * 60 * 1000, buffSuccessBonus: 0.30, buyPrice: 120, sellPrice: 45, description: '+30% Tỉ lệ Đột phá Trúc Cơ (Lv.1 ➔ 2) & +20 XP • Chỉ dành cho cảnh giới Luyện Khí' },
  { id: 'pill_kim_dan', name: 'Kim Đan', emoji: '🟡', iconImage: '/pills/18_kim_nguyen_dan.png', xpValue: 40, maxStack: 99, rarity: 'rare', category: 'breakthrough', targetRealmIndex: 2, breakthroughBonus: 0.28, isBuff: true, buffDurationMs: 5 * 60 * 1000, buffSuccessBonus: 0.28, buyPrice: 260, sellPrice: 95, description: '+28% Tỉ lệ Ngưng Kết Kim Đan (Lv.2 ➔ 3) & +40 XP • Chỉ dành cho cảnh giới Trúc Cơ' },
  { id: 'pill_nguyen_anh', name: 'Nguyên Anh Đan', emoji: '👶', iconImage: '/pills/25_ngung_anh_dan.png', xpValue: 70, maxStack: 99, rarity: 'rare', category: 'breakthrough', targetRealmIndex: 3, breakthroughBonus: 0.25, isBuff: true, buffDurationMs: 5 * 60 * 1000, buffSuccessBonus: 0.25, buyPrice: 480, sellPrice: 180, description: '+25% Tỉ lệ Hóa Sinh Nguyên Anh (Lv.3 ➔ 4) & +70 XP • Chỉ dành cho cảnh giới Kim Đan' },
  { id: 'pill_hoa_than', name: 'Hóa Thần Đan', emoji: '🟣', iconImage: '/pills/29_hoa_than_dan.png', xpValue: 120, maxStack: 99, rarity: 'legendary', category: 'breakthrough', targetRealmIndex: 4, breakthroughBonus: 0.24, isBuff: true, buffDurationMs: 6 * 60 * 1000, buffSuccessBonus: 0.24, buyPrice: 850, sellPrice: 320, description: '+24% Tỉ lệ Đột phá Hóa Thần (Lv.4 ➔ 5) & +120 XP • Chỉ dành cho cảnh giới Nguyên Anh' },
  { id: 'pill_luyen_hu', name: 'Luyện Hư Đan', emoji: '🌌', iconImage: '/pills/33_luyen_hu_dan.png', xpValue: 180, maxStack: 99, rarity: 'legendary', category: 'breakthrough', targetRealmIndex: 5, breakthroughBonus: 0.22, isBuff: true, buffDurationMs: 6 * 60 * 1000, buffSuccessBonus: 0.22, buyPrice: 1300, sellPrice: 500, description: '+22% Tỉ lệ Đột phá Luyện Hư (Lv.5 ➔ 6) & +180 XP • Chỉ dành cho cảnh giới Hóa Thần' },
  { id: 'pill_hop_the', name: 'Hợp Thể Đan', emoji: '⚔️', iconImage: '/pills/35_hop_the_dan.png', xpValue: 220, maxStack: 99, rarity: 'legendary', category: 'breakthrough', targetRealmIndex: 6, breakthroughBonus: 0.20, isBuff: true, buffDurationMs: 6 * 60 * 1000, buffSuccessBonus: 0.20, buyPrice: 1800, sellPrice: 700, description: '+20% Tỉ lệ Đột phá Hợp Thể (Lv.6 ➔ 7) & +220 XP • Chỉ dành cho cảnh giới Luyện Hư' },
  { id: 'pill_dai_thua', name: 'Đại Thừa Đan', emoji: '👑', iconImage: '/pills/37_dai_thua_dan.png', xpValue: 260, maxStack: 99, rarity: 'legendary', category: 'breakthrough', targetRealmIndex: 7, breakthroughBonus: 0.20, isBuff: true, buffDurationMs: 8 * 60 * 1000, buffSuccessBonus: 0.20, buyPrice: 2200, sellPrice: 850, description: '+20% Tỉ lệ Đột phá Đại Thừa (Lv.7 ➔ 8) & +260 XP • Chỉ dành cho cảnh giới Hợp Thể' },
  { id: 'pill_do_kiep', name: 'Độ Kiếp Đan', emoji: '⚡', iconImage: '/pills/41_do_kiep_dan.png', xpValue: 300, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 8, breakthroughBonus: 0.25, isBuff: true, buffDurationMs: 8 * 60 * 1000, buffSuccessBonus: 0.25, buyPrice: 2800, sellPrice: 1100, description: '+25% Tỉ lệ Độ Kiếp Lôi Kiếp (Lv.8 ➔ 9) & +300 XP • Chỉ dành cho cảnh giới Đại Thừa' },
  { id: 'pill_chan_tien', name: 'Chân Tiên Đan', emoji: '✨', iconImage: '/pills/43_chan_tien_dan.png', xpValue: 450, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 9, breakthroughBonus: 0.18, isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.18, buyPrice: 4000, sellPrice: 1600, description: '+18% Tỉ lệ Phi Thăng Chân Tiên (Lv.9 ➔ 10) & +450 XP • Chỉ dành cho cảnh giới Độ Kiếp' },
  { id: 'pill_huyen_tien', name: 'Huyền Tiên Đan', emoji: '💫', iconImage: '/pills/49_huyen_tien_dan.png', xpValue: 550, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 10, breakthroughBonus: 0.18, isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.18, buyPrice: 5000, sellPrice: 2000, description: '+18% Tỉ lệ Đột phá Huyền Tiên (Lv.10 ➔ 11) & +550 XP • Chỉ dành cho cảnh giới Chân Tiên' },
  { id: 'pill_kim_tien', name: 'Kim Tiên Đan', emoji: '🏆', iconImage: '/pills/51_kim_tien_dan.png', xpValue: 650, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 11, breakthroughBonus: 0.18, isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.18, buyPrice: 6000, sellPrice: 2400, description: '+18% Tỉ lệ Đột phá Kim Tiên (Lv.11 ➔ 12) & +650 XP • Chỉ dành cho cảnh giới Huyền Tiên' },
  { id: 'pill_thai_at', name: 'Thái Ất Kim Đan', emoji: '👑', iconImage: '/pills/53_thai_at_ngoc_tien_dan.png', xpValue: 800, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 12, breakthroughBonus: 0.16, isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.16, buyPrice: 7500, sellPrice: 3000, description: '+16% Tỉ lệ Đột phá Thái Ất Ngọc Tiên (Lv.12 ➔ 13) & +800 XP • Chỉ dành cho Kim Tiên' },
  { id: 'pill_thai_at_kim', name: 'Thái Ất Thần Đan', emoji: '🔱', iconImage: '/pills/54_thai_at_kim_tien_dan.png', xpValue: 950, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 13, breakthroughBonus: 0.16, isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.16, buyPrice: 9000, sellPrice: 3600, description: '+16% Tỉ lệ Đột phá Thái Ất Kim Tiên (Lv.13 ➔ 14) & +950 XP • Chỉ dành cho Thái Ất Ngọc Tiên' },
  { id: 'pill_dai_la', name: 'Đại La Đan', emoji: '🌌', iconImage: '/pills/57_dai_la_kim_dan.png', xpValue: 1200, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 14, breakthroughBonus: 0.15, isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.15, buyPrice: 12000, sellPrice: 4800, description: '+15% Tỉ lệ Đột phá Đại La Kim Tiên (Lv.14 ➔ 15) & +1200 XP • Chỉ dành cho Thái Ất Kim Tiên' },
  { id: 'pill_hon_nguyen', name: 'Hỗn Nguyên Đan', emoji: '☯️', iconImage: '/pills/58_hon_nguyen_dan.png', xpValue: 1500, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 15, breakthroughBonus: 0.15, isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.15, buyPrice: 15000, sellPrice: 6000, description: '+15% Tỉ lệ Đột phá Hỗn Nguyên Đại La (Lv.15 ➔ 16) & +1500 XP • Chỉ dành cho Đại La Kim Tiên' },
  { id: 'pill_tien_de', name: 'Tiên Đế Đan', emoji: '👑', iconImage: '/pills/63_tien_de_dao_dan.png', xpValue: 2000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 16, breakthroughBonus: 0.15, isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.15, buyPrice: 20000, sellPrice: 8000, description: '+15% Tỉ lệ Đột phá Tiên Đế Chí Tôn (Lv.16 ➔ 17) & +2000 XP • Chỉ dành cho Hỗn Nguyên Đại La' },

  // ─── Nhóm Đan Dược Buff Đặc Biệt & Hộ Mệnh ───────────────────────────────
  { id: 'pill_ngo_dao', name: 'Ngộ Đạo Đan', emoji: '🧘', iconImage: '/pills/39_ngo_dao_dan.png', xpValue: 30, maxStack: 99, rarity: 'rare', category: 'buff', isBuff: true, buffDurationMs: 15 * 60 * 1000, expMultiplier: 2.0, buyPrice: 450, sellPrice: 170, description: 'x2 Tốc độ nhận Linh Lực (XP) khi treo máy & click Thỏ trong 15 phút' },
  { id: 'pill_thien_dao', name: 'Thiên Đạo Đan', emoji: '🌟', iconImage: '/pills/38_thien_co_dan.png', xpValue: 50, maxStack: 99, rarity: 'legendary', category: 'buff', isBuff: true, buffDurationMs: 15 * 60 * 1000, dropRateMultiplier: 1.5, buyPrice: 850, sellPrice: 330, description: '+50% Tỉ lệ may mắn rơi Thảo Dược & Quặng Hiếm trong 15 phút' },
  { id: 'pill_vo_cuc', name: 'Vô Cực Đan', emoji: '☯️', iconImage: '/pills/60_vo_cuc_dan.png', xpValue: 100, maxStack: 99, rarity: 'supreme', category: 'buff', isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.20, forgeSuccessBonus: 0.20, buyPrice: 1800, sellPrice: 700, description: 'Âm Dương Hỗ Trợ: +20% Tỉ lệ Độ Kiếp & +20% Tỉ lệ Rèn Pháp Bảo trong 10 phút' },
  ...
  { id: 'revive', name: 'Cửu Chuyển Hoàn Hồn Đan', emoji: '🔮', iconImage: '/pills/48_cuu_chuyen_tien_dan.png', xpValue: 100, maxStack: 99, rarity: 'supreme', category: 'breakthrough', isBuff: true, buffDurationMs: 10 * 60 * 1000, buffSuccessBonus: 0.35, buyPrice: 1500, sellPrice: 600, description: '+35% Tỉ lệ Độ Kiếp & Bảo hộ 100% không tổn hại XP khi thất bại (10 phút)' },
