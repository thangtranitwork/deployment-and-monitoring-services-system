...
export const ITEM_CONFIG: ItemConfig[] = [
  // ─── 64 Đan Dược Tu Tiên Tăng Tu Vi theo Cảnh Giới ──────────────────────
  { id: '01_tu_linh_dan', name: 'Tụ Linh Đan', emoji: '💊', iconImage: '/pills/01_tu_linh_dan.png', xpValue: 15, maxStack: 999, rarity: 'common', category: 'xp', buyPrice: 15, sellPrice: 6, description: 'Luyện Khí Kỳ: +15 Linh Lực (XP)' },
  { id: '02_duong_khi_dan', name: 'Dưỡng Khí Đan', emoji: '💊', iconImage: '/pills/02_duong_khi_dan.png', xpValue: 25, maxStack: 999, rarity: 'common', category: 'xp', buyPrice: 25, sellPrice: 10, description: 'Luyện Khí Kỳ: +25 Linh Lực (XP)' },
  { id: '03_tinh_tam_dan', name: 'Tĩnh Tâm Đan', emoji: '🧘', iconImage: '/pills/03_tinh_tam_dan.png', xpValue: 35, maxStack: 999, rarity: 'common', category: 'xp', buyPrice: 35, sellPrice: 14, description: 'Luyện Khí Kỳ: +35 Linh Lực (XP)' },
  { id: '04_hoi_khi_dan', name: 'Hồi Khí Đan', emoji: '🍃', iconImage: '/pills/04_hoi_khi_dan.png', xpValue: 45, maxStack: 999, rarity: 'common', category: 'xp', buyPrice: 45, sellPrice: 18, description: 'Luyện Khí Kỳ: +45 Linh Lực (XP)' },
  { id: '05_luyen_the_dan', name: 'Luyện Thể Đan', emoji: '💪', iconImage: '/pills/05_luyen_the_dan.png', xpValue: 55, maxStack: 999, rarity: 'common', category: 'xp', buyPrice: 55, sellPrice: 22, description: 'Luyện Khí Kỳ: +55 Linh Lực (XP)' },
  { id: '06_khinh_than_dan', name: 'Khinh Thân Đan', emoji: '💨', iconImage: '/pills/06_khinh_than_dan.png', xpValue: 65, maxStack: 999, rarity: 'common', category: 'xp', buyPrice: 65, sellPrice: 26, description: 'Luyện Khí Kỳ: +65 Linh Lực (XP)' },
  { id: '07_thanh_tam_dan', name: 'Thanh Tâm Đan', emoji: '🌿', iconImage: '/pills/07_thanh_tam_dan.png', xpValue: 75, maxStack: 999, rarity: 'common', category: 'xp', buyPrice: 75, sellPrice: 30, description: 'Luyện Khí Kỳ: +75 Linh Lực (XP)' },
  { id: '08_tieu_hoi_xuan_dan', name: 'Tiểu Hồi Xuân Đan', emoji: '🌸', iconImage: '/pills/08_tieu_hoi_xuan_dan.png', xpValue: 85, maxStack: 999, rarity: 'common', category: 'xp', buyPrice: 85, sellPrice: 34, description: 'Luyện Khí Kỳ: +85 Linh Lực (XP)' },
  { id: '09_truc_co_dan', name: 'Trúc Cơ Đan', emoji: '🌱', iconImage: '/pills/09_truc_co_dan.png', xpValue: 120, maxStack: 99, rarity: 'uncommon', category: 'breakthrough', targetRealmIndex: 1, breakthroughBonus: 0.3, isBuff: true, buffDurationMs: 300000, buffSuccessBonus: 0.3, buyPrice: 120, sellPrice: 45, description: '+30% Tỉ lệ Đột phá Trúc Cơ (Lv.1➔2) & +120 XP' },
  { id: '10_co_nguyen_dan', name: 'Cố Nguyên Đan', emoji: '🪵', iconImage: '/pills/10_co_nguyen_dan.png', xpValue: 140, maxStack: 999, rarity: 'uncommon', category: 'xp', buyPrice: 140, sellPrice: 55, description: 'Trúc Cơ Kỳ: +140 Linh Lực (XP)' },
  { id: '11_tay_tuy_dan', name: 'Tẩy Tủy Đan', emoji: '💧', iconImage: '/pills/11_tay_tuy_dan.png', xpValue: 160, maxStack: 999, rarity: 'uncommon', category: 'xp', buyPrice: 160, sellPrice: 65, description: 'Trúc Cơ Kỳ: +160 Linh Lực (XP)' },
  { id: '12_thong_mach_dan', name: 'Thông Mạch Đan', emoji: '⚡', iconImage: '/pills/12_thong_mach_dan.png', xpValue: 180, maxStack: 999, rarity: 'uncommon', category: 'xp', buyPrice: 180, sellPrice: 75, description: 'Trúc Cơ Kỳ: +180 Linh Lực (XP)' },
  { id: '13_linh_luc_dan', name: 'Linh Lực Đan', emoji: '✨', iconImage: '/pills/13_linh_luc_dan.png', xpValue: 200, maxStack: 999, rarity: 'uncommon', category: 'xp', buyPrice: 200, sellPrice: 80, description: 'Trúc Cơ Kỳ: +200 Linh Lực (XP)' },
  { id: '14_ho_mach_dan', name: 'Hộ Mạch Đan', emoji: '🛡️', iconImage: '/pills/14_ho_mach_dan.png', xpValue: 220, maxStack: 999, rarity: 'uncommon', category: 'xp', buyPrice: 220, sellPrice: 90, description: 'Trúc Cơ Kỳ: +220 Linh Lực (XP)' },
  { id: '15_ngung_khi_dan', name: 'Ngưng Khí Đan', emoji: '🌀', iconImage: '/pills/15_ngung_khi_dan.png', xpValue: 250, maxStack: 999, rarity: 'uncommon', category: 'xp', buyPrice: 250, sellPrice: 100, description: 'Trúc Cơ Kỳ: +250 Linh Lực (XP)' },
  { id: '16_truc_co_thuong_pham_dan', name: 'Trúc Cơ Thượng Phẩm Đan', emoji: '🌟', iconImage: '/pills/16_truc_co_thuong_pham_dan.png', xpValue: 300, maxStack: 999, rarity: 'uncommon', category: 'xp', buyPrice: 300, sellPrice: 120, description: 'Trúc Cơ Kỳ: +300 Linh Lực (XP)' },
  { id: '17_ket_dan_dan', name: 'Kết Đan Đan', emoji: '🔮', iconImage: '/pills/17_ket_dan_dan.png', xpValue: 400, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 400, sellPrice: 150, description: 'Kim Đan Kỳ: +400 Linh Lực (XP)' },
  { id: '18_kim_nguyen_dan', name: 'Kim Nguyên Đan', emoji: '🟡', iconImage: '/pills/18_kim_nguyen_dan.png', xpValue: 500, maxStack: 99, rarity: 'rare', category: 'breakthrough', targetRealmIndex: 2, breakthroughBonus: 0.28, isBuff: true, buffDurationMs: 300000, buffSuccessBonus: 0.28, buyPrice: 500, sellPrice: 190, description: '+28% Tỉ lệ Ngưng Kết Kim Đan (Lv.2➔3) & +500 XP' },
  { id: '19_tu_kim_dan', name: 'Tử Kim Đan', emoji: '🟣', iconImage: '/pills/19_tu_kim_dan.png', xpValue: 600, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 600, sellPrice: 230, description: 'Kim Đan Kỳ: +600 Linh Lực (XP)' },
  { id: '20_ngung_dan_dan', name: 'Ngưng Đan Đan', emoji: '💎', iconImage: '/pills/20_ngung_dan_dan.png', xpValue: 700, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 700, sellPrice: 270, description: 'Kim Đan Kỳ: +700 Linh Lực (XP)' },
  { id: '21_ho_dan_dan', name: 'Hộ Đan Đan', emoji: '🛡️', iconImage: '/pills/21_ho_dan_dan.png', xpValue: 800, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 800, sellPrice: 310, description: 'Kim Đan Kỳ: +800 Linh Lực (XP)' },
  { id: '22_kim_cuong_the_dan', name: 'Kim Cương Thể Đan', emoji: '🧱', iconImage: '/pills/22_kim_cuong_the_dan.png', xpValue: 900, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 900, sellPrice: 350, description: 'Kim Đan Kỳ: +900 Linh Lực (XP)' },
  { id: '23_phuc_nguyen_dan', name: 'Phục Nguyên Đan', emoji: '🌸', iconImage: '/pills/23_phuc_nguyen_dan.png', xpValue: 1000, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 1000, sellPrice: 400, description: 'Kim Đan Kỳ: +1,000 Linh Lực (XP)' },
  { id: '24_dai_hoi_khi_dan', name: 'Đại Hồi Khí Đan', emoji: '🔥', iconImage: '/pills/24_dai_hoi_khi_dan.png', xpValue: 1200, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 1200, sellPrice: 480, description: 'Kim Đan Kỳ: +1,200 Linh Lực (XP)' },
  { id: '25_ngung_anh_dan', name: 'Ngưng Anh Đan', emoji: '👶', iconImage: '/pills/25_ngung_anh_dan.png', xpValue: 1500, maxStack: 99, rarity: 'rare', category: 'breakthrough', targetRealmIndex: 3, breakthroughBonus: 0.25, isBuff: true, buffDurationMs: 300000, buffSuccessBonus: 0.25, buyPrice: 1500, sellPrice: 600, description: '+25% Tỉ lệ Hóa Sinh Nguyên Anh (Lv.3➔4) & +1,500 XP' },
  { id: '26_anh_linh_dan', name: 'Anh Linh Đan', emoji: '👻', iconImage: '/pills/26_anh_linh_dan.png', xpValue: 1800, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 1800, sellPrice: 720, description: 'Nguyên Anh Kỳ: +1,800 Linh Lực (XP)' },
  { id: '27_duong_hon_dan', name: 'Dưỡng Hồn Đan', emoji: '🔮', iconImage: '/pills/27_duong_hon_dan.png', xpValue: 2200, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 2200, sellPrice: 880, description: 'Nguyên Anh Kỳ: +2,200 Linh Lực (XP)' },
  { id: '28_ho_hon_dan', name: 'Hộ Hồn Đan', emoji: '🛡️', iconImage: '/pills/28_ho_hon_dan.png', xpValue: 2600, maxStack: 999, rarity: 'rare', category: 'xp', buyPrice: 2600, sellPrice: 1040, description: 'Nguyên Anh Kỳ: +2,600 Linh Lực (XP)' },
  { id: '29_hoa_than_dan', name: 'Hóa Thần Đan', emoji: '🟣', iconImage: '/pills/29_hoa_than_dan.png', xpValue: 3000, maxStack: 99, rarity: 'legendary', category: 'breakthrough', targetRealmIndex: 4, breakthroughBonus: 0.24, isBuff: true, buffDurationMs: 360000, buffSuccessBonus: 0.24, buyPrice: 3000, sellPrice: 1200, description: '+24% Tỉ lệ Đột phá Hóa Thần (Lv.4➔5) & +3,000 XP' },
  { id: '30_than_niem_dan', name: 'Thần Niệm Đan', emoji: '⚡', iconImage: '/pills/30_than_niem_dan.png', xpValue: 3500, maxStack: 999, rarity: 'legendary', category: 'xp', buyPrice: 3500, sellPrice: 1400, description: 'Hóa Thần Kỳ: +3,500 Linh Lực (XP)' },
  { id: '31_loi_hon_dan', name: 'Lôi Hồn Đan', emoji: '🌩️', iconImage: '/pills/31_loi_hon_dan.png', xpValue: 4000, maxStack: 999, rarity: 'legendary', category: 'xp', buyPrice: 4000, sellPrice: 1600, description: 'Hóa Thần Kỳ: +4,000 Linh Lực (XP)' },
  { id: '32_than_luc_dan', name: 'Thần Lực Đan', emoji: '💥', iconImage: '/pills/32_than_luc_dan.png', xpValue: 4800, maxStack: 999, rarity: 'legendary', category: 'xp', buyPrice: 4800, sellPrice: 1900, description: 'Hóa Thần Kỳ: +4,800 Linh Lực (XP)' },
  { id: '33_luyen_hu_dan', name: 'Luyện Hư Đan', emoji: '🌌', iconImage: '/pills/33_luyen_hu_dan.png', xpValue: 6000, maxStack: 99, rarity: 'legendary', category: 'breakthrough', targetRealmIndex: 5, breakthroughBonus: 0.22, isBuff: true, buffDurationMs: 360000, buffSuccessBonus: 0.22, buyPrice: 6000, sellPrice: 2400, description: '+22% Tỉ lệ Đột phá Luyện Hư (Lv.5➔6) & +6,000 XP' },
  { id: '34_hu_khong_dan', name: 'Hư Không Đan', emoji: '🌀', iconImage: '/pills/34_hu_khong_dan.png', xpValue: 7500, maxStack: 999, rarity: 'legendary', category: 'xp', buyPrice: 7500, sellPrice: 3000, description: 'Luyện Hư Kỳ: +7,500 Linh Lực (XP)' },
  { id: '35_hop_the_dan', name: 'Hợp Thể Đan', emoji: '⚔️', iconImage: '/pills/35_hop_the_dan.png', xpValue: 9000, maxStack: 99, rarity: 'legendary', category: 'breakthrough', targetRealmIndex: 6, breakthroughBonus: 0.2, isBuff: true, buffDurationMs: 360000, buffSuccessBonus: 0.2, buyPrice: 9000, sellPrice: 3600, description: '+20% Tỉ lệ Đột phá Hợp Thể (Lv.6➔7) & +9,000 XP' },
  { id: '36_am_duong_dan', name: 'Âm Dương Đan', emoji: '☯️', iconImage: '/pills/36_am_duong_dan.png', xpValue: 11000, maxStack: 999, rarity: 'legendary', category: 'xp', buyPrice: 11000, sellPrice: 4400, description: 'Hợp Thể Kỳ: +11,000 Linh Lực (XP)' },
  { id: '37_dai_thua_dan', name: 'Đại Thừa Đan', emoji: '👑', iconImage: '/pills/37_dai_thua_dan.png', xpValue: 13000, maxStack: 99, rarity: 'legendary', category: 'breakthrough', targetRealmIndex: 7, breakthroughBonus: 0.2, isBuff: true, buffDurationMs: 480000, buffSuccessBonus: 0.2, buyPrice: 13000, sellPrice: 5200, description: '+20% Tỉ lệ Đột phá Đại Thừa (Lv.7➔8) & +13,000 XP' },
  { id: '38_thien_co_dan', name: 'Thiên Cơ Đan', emoji: '📜', iconImage: '/pills/38_thien_co_dan.png', xpValue: 15000, maxStack: 999, rarity: 'legendary', category: 'xp', buyPrice: 15000, sellPrice: 6000, description: 'Đại Thừa Kỳ: +15,000 Linh Lực (XP)' },
  { id: '39_ngo_dao_dan', name: 'Ngộ Đạo Đan', emoji: '🌟', iconImage: '/pills/39_ngo_dao_dan.png', xpValue: 18000, maxStack: 999, rarity: 'legendary', category: 'xp', buyPrice: 18000, sellPrice: 7200, description: 'Đại Thừa Kỳ: +18,000 Linh Lực (XP)' },
  { id: '40_pha_canh_dan', name: 'Phá Cảnh Đan', emoji: '🚀', iconImage: '/pills/40_pha_canh_dan.png', xpValue: 22000, maxStack: 999, rarity: 'legendary', category: 'xp', buyPrice: 22000, sellPrice: 8800, description: 'Đại Thừa Kỳ: +22,000 Linh Lực (XP)' },
  { id: '41_do_kiep_dan', name: 'Độ Kiếp Đan', emoji: '⚡', iconImage: '/pills/41_do_kiep_dan.png', xpValue: 28000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 8, breakthroughBonus: 0.25, isBuff: true, buffDurationMs: 480000, buffSuccessBonus: 0.25, buyPrice: 28000, sellPrice: 11000, description: '+25% Tỉ lệ Độ Kiếp Lôi Kiếp (Lv.8➔9) & +28,000 XP' },
  { id: '42_loi_kiep_ho_menh_dan', name: 'Lôi Kiếp Hộ Mệnh Đan', emoji: '🛡️', iconImage: '/pills/42_loi_kiep_ho_menh_dan.png', xpValue: 35000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 35000, sellPrice: 14000, description: 'Độ Kiếp Kỳ: +35,000 Linh Lực (XP)' },
  { id: '43_chan_tien_dan', name: 'Chân Tiên Đan', emoji: '✨', iconImage: '/pills/43_chan_tien_dan.png', xpValue: 42000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 9, breakthroughBonus: 0.18, isBuff: true, buffDurationMs: 600000, buffSuccessBonus: 0.18, buyPrice: 42000, sellPrice: 16800, description: '+18% Tỉ lệ Phi Thăng Chân Tiên (Lv.9➔10) & +42,000 XP' },
  { id: '44_tien_linh_dan', name: 'Tiên Linh Đan', emoji: '💫', iconImage: '/pills/44_tien_linh_dan.png', xpValue: 50000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 50000, sellPrice: 20000, description: 'Chân Tiên: +50,000 Linh Lực (XP)' },
  { id: '45_tien_cot_dan', name: 'Tiên Cốt Đan', emoji: '🦴', iconImage: '/pills/45_tien_cot_dan.png', xpValue: 60000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 60000, sellPrice: 24000, description: 'Chân Tiên: +60,000 Linh Lực (XP)' },
  { id: '46_tien_hon_dan', name: 'Tiên Hồn Đan', emoji: '👻', iconImage: '/pills/46_tien_hon_dan.png', xpValue: 72000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 72000, sellPrice: 28800, description: 'Chân Tiên: +72,000 Linh Lực (XP)' },
  { id: '47_tien_nguyen_dan', name: 'Tiên Nguyên Đan', emoji: '🔮', iconImage: '/pills/47_tien_nguyen_dan.png', xpValue: 85000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 85000, sellPrice: 34000, description: 'Chân Tiên: +85,000 Linh Lực (XP)' },
  { id: '48_cuu_chuyen_tien_dan', name: 'Cửu Chuyển Hoàn Hồn Đan', emoji: '👑', iconImage: '/pills/48_cuu_chuyen_tien_dan.png', xpValue: 100000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 100000, sellPrice: 40000, description: 'Chân Tiên Tối Cao: +100,000 Linh Lực (XP)' },
  { id: '49_huyen_tien_dan', name: 'Huyền Tiên Đan', emoji: '💫', iconImage: '/pills/49_huyen_tien_dan.png', xpValue: 120000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 10, breakthroughBonus: 0.18, isBuff: true, buffDurationMs: 600000, buffSuccessBonus: 0.18, buyPrice: 120000, sellPrice: 48000, description: '+18% Tỉ lệ Đột phá Huyền Tiên (Lv.10➔11) & +120,000 XP' },
  { id: '50_phap_tac_dan', name: 'Pháp Tắc Đan', emoji: '📜', iconImage: '/pills/50_phap_tac_dan.png', xpValue: 150000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 150000, sellPrice: 60000, description: 'Huyền Tiên: +150,000 Linh Lực (XP)' },
  { id: '51_kim_tien_dan', name: 'Kim Tiên Đan', emoji: '🏆', iconImage: '/pills/51_kim_tien_dan.png', xpValue: 180000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 11, breakthroughBonus: 0.18, isBuff: true, buffDurationMs: 600000, buffSuccessBonus: 0.18, buyPrice: 180000, sellPrice: 72000, description: '+18% Tỉ lệ Đột phá Kim Tiên (Lv.11➔12) & +180,000 XP' },
  { id: '52_kim_tien_bat_diet_dan', name: 'Kim Tiên Bất Diệt Đan', emoji: '🛡️', iconImage: '/pills/52_kim_tien_bat_diet_dan.png', xpValue: 220000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 220000, sellPrice: 88000, description: 'Kim Tiên: +220,000 Linh Lực (XP)' },
  { id: '53_thai_at_ngoc_tien_dan', name: 'Thái Ất Ngọc Tiên Đan', emoji: '🏺', iconImage: '/pills/53_thai_at_ngoc_tien_dan.png', xpValue: 260000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 12, breakthroughBonus: 0.16, isBuff: true, buffDurationMs: 600000, buffSuccessBonus: 0.16, buyPrice: 260000, sellPrice: 104000, description: '+16% Tỉ lệ Đột phá Thái Ất Ngọc Tiên (Lv.12➔13) & +260,000 XP' },
  { id: '54_thai_at_kim_tien_dan', name: 'Thái Ất Kim Tiên Đan', emoji: '🔱', iconImage: '/pills/54_thai_at_kim_tien_dan.png', xpValue: 320000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 13, breakthroughBonus: 0.16, isBuff: true, buffDurationMs: 600000, buffSuccessBonus: 0.16, buyPrice: 320000, sellPrice: 128000, description: '+16% Tỉ lệ Đột phá Thái Ất Kim Tiên (Lv.13➔14) & +320,000 XP' },
  { id: '55_van_phap_dan', name: 'Vạn Pháp Đan', emoji: '🌌', iconImage: '/pills/55_van_phap_dan.png', xpValue: 400000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 400000, sellPrice: 160000, description: 'Thái Ất Kim Tiên: +400,000 Linh Lực (XP)' },
  { id: '56_dai_la_dao_dan', name: 'Đại La Đạo Đan', emoji: '🔮', iconImage: '/pills/56_dai_la_dao_dan.png', xpValue: 500000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 500000, sellPrice: 200000, description: 'Thái Ất Kim Tiên: +500,000 Linh Lực (XP)' },
  { id: '57_dai_la_kim_dan', name: 'Đại La Kim Đan', emoji: '🌌', iconImage: '/pills/57_dai_la_kim_dan.png', xpValue: 650000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 14, breakthroughBonus: 0.15, isBuff: true, buffDurationMs: 600000, buffSuccessBonus: 0.15, buyPrice: 650000, sellPrice: 260000, description: '+15% Tỉ lệ Đột phá Đại La Kim Tiên (Lv.14➔15) & +650,000 XP' },
  { id: '58_hon_nguyen_dan', name: 'Hỗn Nguyên Đan', emoji: '☯️', iconImage: '/pills/58_hon_nguyen_dan.png', xpValue: 850000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 15, breakthroughBonus: 0.15, isBuff: true, buffDurationMs: 600000, buffSuccessBonus: 0.15, buyPrice: 850000, sellPrice: 340000, description: '+15% Tỉ lệ Đột phá Hỗn Nguyên Đại La (Lv.15➔16) & +850,000 XP' },
  { id: '59_hon_don_dao_dan', name: 'Hỗn Độn Đạo Đan', emoji: '🌀', iconImage: '/pills/59_hon_don_dao_dan.png', xpValue: 1100000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 1100000, sellPrice: 440000, description: 'Hỗn Nguyên Đại La: +1,100,000 Linh Lực (XP)' },
  { id: '60_vo_cuc_dan', name: 'Vô Cực Đan', emoji: '☯️', iconImage: '/pills/60_vo_cuc_dan.png', xpValue: 1400000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 1400000, sellPrice: 560000, description: 'Hỗn Nguyên Đại La: +1,400,000 Linh Lực (XP)' },
  { id: '61_hong_mong_dan', name: 'Hồng Mông Đan', emoji: '✨', iconImage: '/pills/61_hong_mong_dan.png', xpValue: 1800000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 1800000, sellPrice: 720000, description: 'Tiên Đế Chí Tôn: +1,800,000 Linh Lực (XP)' },
  { id: '62_tao_hoa_dan', name: 'Tạo Hóa Đan', emoji: '🌱', iconImage: '/pills/62_tao_hoa_dan.png', xpValue: 2200000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 2200000, sellPrice: 880000, description: 'Tiên Đế Chí Tôn: +2,200,000 Linh Lực (XP)' },
  { id: '63_tien_de_dao_dan', name: 'Tiên Đế Đạo Đan', emoji: '👑', iconImage: '/pills/63_tien_de_dao_dan.png', xpValue: 2700000, maxStack: 99, rarity: 'supreme', category: 'breakthrough', targetRealmIndex: 16, breakthroughBonus: 0.15, isBuff: true, buffDurationMs: 600000, buffSuccessBonus: 0.15, buyPrice: 2700000, sellPrice: 1080000, description: '+15% Tỉ lệ Đột phá Tiên Đế Chí Tôn (Lv.16➔17) & +2,700,000 XP' },
  { id: '64_vo_cuc_hong_mong_tien_de_dan', name: 'Vô Cực Hồng Mông Tiên Đế Đan', emoji: '👑', iconImage: '/pills/64_vo_cuc_hong_mong_tien_de_dan.png', xpValue: 3500000, maxStack: 999, rarity: 'supreme', category: 'xp', buyPrice: 3500000, sellPrice: 1400000, description: 'Tối Cao Tam Giới: +3,500,000 Linh Lực (XP)' },
